...
(function () {
  ...
  var r,
    ...
    j = {};
  for (r = 0; r < 256; ++r)
    (A = r.toString(16)), r < 16 && (A = '0' + A), (C[A] = C[A.toUpperCase()] = r.toString() + ',');
  function n(a) {
  ...
  function az(g, j, l, m, f) {
    ...
    for (a = 0; a < g; ++a)
      (b = a * h - 1 + h / 2), (c = B(1 - b * b)), (d = a * i), e.push([k(d) * c * j, b * l, o(d) * c * m]);
    return e;
  }
  ...
  function aa(l, e, f, h, i, j) {
    var b,
      ...
      d;
    for (a = 0; a < e; ++a)
      (b = a * m), (c = k(b)), (d = o(b)), g.push(l ? [j * f, c * h, d * i] : [c * f, j * h, d * i]);
    return g;
  }
      ...
      a[0] === '#'
        ? (K[a] ||
            (a.length === 4
              ...
              : (K[a] = 'rgba(' + C[a.substr(1, 2)] + C[a.substr(3, 2)] + C[a.substr(5, 2)])),
          (b = K[a] + f))
        ...
        this.image &&
          ...
          this.ipos == 'top' || this.ipos == 'bottom'
            ...
            : (d < this.height
              ...
              this.ipos == 'right' ? (x += this.width + this.ipad) : (w += c + this.ipad),
              (e += c + this.ipad),
              (f = g(f, d + i)))),
        (o = l(e, f)),
        !o
          ...
          : ((k = i = b / 2),
            ...
            b && ((a.strokeStyle = F), (a.lineWidth = b), v(a, k, i, s, u, y, !0)),
            (m || B || C) && ((t = l(e, f)), t && ((z = a), (a = t.getContext('2d')))),
            _(a, this.font, G, this.strings, w, r, 0, 0, [], this.maxWidth, this.stringWidths, this.align),
    ...
    (f.width = f.width),
      ...
      b.txtOpt &&
        ...
        e < f.naturalWidth || d < f.naturalHeight
          ...
          : ((e = a.iw), (d = a.ih), (g = 1)),
        parseFloat(b.imageRadius) && (a.image = a.fimage = h = at(a.image, b.imageRadius, e, d, g)),
        a.HasText() ||
          (b.shadow &&
          ...
          (b.bgColour || b.bgOutlineThickness) &&
            ((j = b.bgColour == 'tag' ? i(a.a, 'background-color') : b.bgColour),
            (l = b.bgOutline == 'tag' ? i(a.a, 'color') : b.bgOutline || b.textColour),
            (e = a.fimage.width),
            (d = a.fimage.height),
            b.outlineMethod == 'colour' &&
              ((c = ab(a.fimage, e, d, g, j, b.bgOutlineThickness, a.outline.colour, b.padding, b.bgRadius, 1)),
              c && (a.oimage = c.image)),
            (c = ab(a.fimage, e, d, g, j, b.bgOutlineThickness, l, b.padding, b.bgRadius)),
            c && ((a.fimage = c.image), (a.w = c.width), (a.h = c.height))),
  ...
  function i(a, c) {
    ...
    return (
      (b && b.getComputedStyle && b.getComputedStyle(a, null).getPropertyValue(c)) ||
  ...
  function ar(c) {
    ...
    b &&
      ...
      (c.touches.length == 1 && b.touchState == 0
        ? ((b.touchState = 1), b.BeginDrag(c), (d = J(c, b.canvas)) && ((b.mx = d.x), (b.my = d.y), (b.drawn = 0)))
  ...
  (f = V.prototype),
    ...
    (f.DrawColour = function (d, h, i, e, f, g, a, b, c) {
      return a.oimage
        ? (this.pulse < 1
            ? ((a.alpha = 1 - x(this.pulse, 2)), a.Draw(d, b, c, a.fimage), (a.alpha = this.pulse))
            : (a.alpha = 1),
    ...
    (f.DrawPulsate = function (h, d, e, f) {
      var g = q() - this.ts,
        c = this.tc,
        b = c.pulsateTo + (1 - c.pulsateTo) * (0.5 + k((2 * Math.PI * g) / (1e3 * c.pulsateTime)) / 2);
    ...
    (c.Measure = function (e, a) {
      ...
      (j = f ? f.max.y + f.min.y : this.textHeight),
        ...
        a.txtOpt &&
          ...
          (d = new T(this.text, h, g + b, b * j + b, g, this.line_widths, a.textAlign, a.textVAlign, b)),
          this.image &&
            d.SetImage(
              this.image,
              this.iw,
          ...
          a.outlineMethod == 'colour'
            ...
            : a.outlineMethod == 'size' &&
              ...
              (e.font = h),
              (g = this.MeasureText(e)),
              (d = new T(this.text, h, g + b, b * k + b, g, this.line_widths, a.textAlign, a.textVAlign, b)),
              this.image &&
                d.SetImage(
                  this.image,
  ...
  function a(f, o, k) {
    ...
    if (
      ...
      this.shadowBlur || this.shadowOffset[0] || this.shadowOffset[1]
        ? ((this.ctxt.shadowColor = this.shadow), (this.shadow = this.ctxt.shadowColor), (this.shadowAlpha = aC()))
        : delete this.shadow,
      ...
      (j[f] = [
        ...
        this.dragControl && (j[f].push(['mousedown', ap]), j[f].push(['selectstart', w])),
        this.wheelZoom && (j[f].push(['mousewheel', $]), j[f].push(['DOMMouseScroll', $])),
  ...
  (b = a.prototype),
    ...
    (b.Message = function (j) {
      ...
      for (a = 0; a < b.length; ++a)
        b[a] != ' ' &&
          ...
          (h = 100 * o(f / 9)),
          (i = -100 * k(f / 9)),
          (e = new I(this, b[a], c, [h, 0, i], 2, 18, '#000', '#fff', 0, 0, 0, 'monospace', 2, b[a])),
          e.Init(),
          g.push(e));
      return g;
    }),
      ...
      if ('text' != this.imageMode)
        if (((e = b.getElementsByTagName('img')), e.length))
          if (((c = new Image()), (c.src = e[0].src), !this.imageMode))
            return (a = new I(this, '', b, k, 0, 0)), a.SetImage(c), F(c, e[0], a, this), this.AddAudio(b, a), a;
      if (
    ...
    (b.ShowAudioIcon = function () {
      ...
      if (!e) return;
      b || (b = e.state === l),
        this.audioIcon && this.hasAudio && (Z(b, d, a, k, f, g + 1, j ? i : h), Z(b, d, a, k, f, g, j ? h : i));
    }),
  ...
  (a.Linear = function (a, b) {
    ...
    (a.Delete = function (b) {
      var c, e;
      if (j[b]) if (((e = d.getElementById(b)), e)) for (c = 0; c < j[b].length; ++c) aj(j[b][c][0], j[b][c][1], e);
